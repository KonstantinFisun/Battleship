...
readFile(Board) :-
    open('C:/Users/kosty/OneDrive/Документы/GitHub/Battleship/Battleship_PYGUI/board.txt', read, Stream),
    readStream(Stream, Board).

readShips(Board) :-
    open('C:/Users/kosty/OneDrive/Документы/GitHub/Battleship/Battleship_PYGUI/ships.txt', read, Stream),
    readStream(Stream, Board).
